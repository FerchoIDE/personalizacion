...
function $render(opt_data, opt_ijData, opt_ijData_deprecated) {
  ...
  var finalValue__soy1881 = (value != null) ? value : '';
  ...
  incrementalDom.elementOpenEnd();
    ...
    if (localizable == true) {
      var language1923List = availableLanguageIds;
      var language1923ListLen = language1923List.length;
      for (var language1923Index = 0; language1923Index < language1923ListLen; language1923Index++) {
          var language1923Data = language1923List[language1923Index];
          if (language1923Data == defaultLanguageId) {
            incrementalDom.elementOpenStart('input');
                incrementalDom.attr('class', 'form-control');
                incrementalDom.attr('data-onkeyup', 'handleChange');
                incrementalDom.attr('id', 'input_' + id + '_' + language1923Data);
                incrementalDom.attr('data-language', language1923Data);
