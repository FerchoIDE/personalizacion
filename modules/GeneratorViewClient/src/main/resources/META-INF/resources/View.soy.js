    ...
    incrementalDom.elementOpenEnd();
      ...
      incrementalDom.elementOpenEnd();
        incrementalDom.elementOpenStart('a');
            ...
            incrementalDom.attr('style', 'font-size: 18px');
            incrementalDom.attr('aria-expanded', selectedTab == 'navUnderlineGymsTab' ? 'true' : 'false');
            incrementalDom.attr('class', (selectedTab == 'navUnderlineGymsTab' ? 'active' : '') + ' nav-link');
            incrementalDom.attr('data-toggle', 'tab');
      ...
      incrementalDom.elementOpenEnd();
        incrementalDom.elementOpenStart('a');
            ...
            incrementalDom.attr('style', 'font-size: 18px');
            incrementalDom.attr('aria-expanded', selectedTab == 'navUnderlineDestinationsTab' ? 'true' : 'false');
            incrementalDom.attr('class', (selectedTab == 'navUnderlineDestinationsTab' ? 'active' : '') + ' nav-link');
            incrementalDom.attr('data-toggle', 'tab');
      ...
      incrementalDom.elementOpenEnd();
        incrementalDom.elementOpenStart('a');
            ...
            incrementalDom.attr('style', 'font-size: 18px');
            incrementalDom.attr('aria-expanded', selectedTab == 'navUnderlineFacilitiesTab' ? 'true' : 'false');
            incrementalDom.attr('class', (selectedTab == 'navUnderlineFacilitiesTab' ? 'active' : '') + ' nav-link');
            incrementalDom.attr('data-toggle', 'tab');
      ...
      incrementalDom.elementOpenEnd();
        incrementalDom.elementOpenStart('a');
            ...
            incrementalDom.attr('style', 'font-size: 18px');
            incrementalDom.attr('aria-expanded', selectedTab == 'navUnderlineChildrensClubTab' ? 'true' : 'false');
            incrementalDom.attr('class', (selectedTab == 'navUnderlineChildrensClubTab' ? 'active' : '') + ' nav-link');
            incrementalDom.attr('data-toggle', 'tab');
      ...
      incrementalDom.elementOpenEnd();
        incrementalDom.elementOpenStart('a');
            ...
            incrementalDom.attr('style', 'font-size: 18px');
            incrementalDom.attr('aria-expanded', selectedTab == 'navUnderlineMeetingRoomsTab' ? 'true' : 'false');
            incrementalDom.attr('class', (selectedTab == 'navUnderlineMeetingRoomsTab' ? 'active' : '') + ' nav-link');
            incrementalDom.attr('data-toggle', 'tab');
      ...
      incrementalDom.elementOpenEnd();
        incrementalDom.elementOpenStart('a');
            ...
            incrementalDom.attr('style', 'font-size: 18px');
            incrementalDom.attr('aria-expanded', selectedTab == 'navUnderlineGenericsTab' ? 'true' : 'false');
            incrementalDom.attr('class', (selectedTab == 'navUnderlineGenericsTab' ? 'active' : '') + ' nav-link');
            incrementalDom.attr('data-toggle', 'tab');
