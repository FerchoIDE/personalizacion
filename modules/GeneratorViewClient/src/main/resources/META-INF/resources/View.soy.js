    ...
    incrementalDom.elementOpenEnd();
      ...
      incrementalDom.elementOpenEnd();
        incrementalDom.elementOpenStart('a');
            ...
            incrementalDom.attr('href', navigationNewURL + '&_generatorviewclient_structureId=119201');
        incrementalDom.elementOpenEnd();
          incrementalDom.text('Hoteles');
        incrementalDom.elementClose('a');
        incrementalDom.elementOpenStart('a');
            incrementalDom.attr('class', 'dropdown-item');
            incrementalDom.attr('href', navigationNewURL + '&_generatorviewclient_structureId=119204');
        incrementalDom.elementOpenEnd();
          incrementalDom.text('Habitaciones');
        incrementalDom.elementClose('a');
        incrementalDom.elementOpenStart('a');
            incrementalDom.attr('class', 'dropdown-item');
            incrementalDom.attr('href', navigationNewURL + '&_generatorviewclient_structureId=121330');
        incrementalDom.elementOpenEnd();
          incrementalDom.text('Promociones');
        incrementalDom.elementClose('a');
        incrementalDom.elementOpenStart('a');
            incrementalDom.attr('class', 'dropdown-item');
            incrementalDom.attr('href', navigationNewURL + '&_generatorviewclient_structureId=121324');
        incrementalDom.elementOpenEnd();
          incrementalDom.text('Bar');
        incrementalDom.elementClose('a');
        incrementalDom.elementOpenStart('a');
            incrementalDom.attr('class', 'dropdown-item');
            incrementalDom.attr('href', navigationNewURL + '&_generatorviewclient_structureId=119207');
        incrementalDom.elementOpenEnd();
          incrementalDom.text('Restaurante');
        incrementalDom.elementClose('a');
        incrementalDom.elementOpenStart('a');
            incrementalDom.attr('class', 'dropdown-item');
            incrementalDom.attr('href', navigationNewURL + '&_generatorviewclient_structureId=121327');
        incrementalDom.elementOpenEnd();
