...
function $render(opt_data, opt_ijData, opt_ijData_deprecated) {
  ...
  var _itemsAsociated__soy7419 = (itemsAsociated != null) ? itemsAsociated[id] : itemsAsociated;
  var _isOpen__soy7421 = (isOpen != null) ? isOpen : {'a': false};
  var m__soy7423 = {'a': false};
  var _host___soy7425 = (pathBase != null) ? pathBase : 'localhost:8080';
            ...
            incrementalDom.elementOpenEnd();
              ...
              incrementalDom.elementOpenEnd();
                incrementalDom.elementOpen('tbody');
                  if (_itemsAsociated__soy7419 != null) {
                    var field7577List = (soy.$$getMapKeys(_itemsAsociated__soy7419));
                    var field7577ListLen = field7577List.length;
                    for (var field7577Index = 0; field7577Index < field7577ListLen; field7577Index++) {
                        var field7577Data = field7577List[field7577Index];
                        var _isOpenField__soy7433 = _isOpen__soy7421[field7577Data] ? 'true' : 'false';
                          if (field7577Index == 0) {
                            incrementalDom.elementOpen('tr');
                          }
                          if ((field7577Index + 2) % 2 == 0 && !(field7577Index == 0)) {
                          ...
                          incrementalDom.elementOpenEnd();
                            ...
                            incrementalDom.elementOpenEnd();
                              ...
                              incrementalDom.elementOpenEnd();
                                ...
                                incrementalDom.elementOpenEnd();
                                  incrementalDom.elementOpenStart('img');
                                      ...
                                      incrementalDom.attr('src', 'http://' + _host___soy7425 + _itemsAsociated__soy7419[field7577Data].imageThumbnail);
                                  incrementalDom.elementOpenEnd();
                              ...
                              incrementalDom.elementOpenEnd();
                                ...
                                incrementalDom.elementOpenEnd();
                                  ...
                                  incrementalDom.elementOpenEnd();
                                    soyIdom.print(_itemsAsociated__soy7419[field7577Data].filename);
                                  incrementalDom.elementClose('a');
                                incrementalDom.elementClose('h4');
                                incrementalDom.elementOpenStart('p');
                                    incrementalDom.attr('class', 'text-truncate-inline');
                                incrementalDom.elementOpenEnd();
                                  soyIdom.print(_itemsAsociated__soy7419[field7577Data].path);
                              ...
                              incrementalDom.elementOpenEnd();
                                incrementalDom.elementOpenStart('a');
                                    ...
                                    incrementalDom.attr('href', '#1');
                                    incrementalDom.attr('id', field7577Data);
                            ...
                            incrementalDom.elementOpenEnd();
                              ...
                              incrementalDom.elementOpenEnd();
                                incrementalDom.elementOpenStart('a');
                                    incrementalDom.attr('aria-controls', 'accordion03CollapseTwo' + field7577Data);
                                    incrementalDom.attr('aria-expanded', _isOpenField__soy7433);
                                    ...
                                    incrementalDom.attr('href', '#accordion03CollapseTwo' + field7577Data);
                                    incrementalDom.attr('id', 'accordion03HeadingTwo__' + field7577Data);
                                ...
                                incrementalDom.elementClose('a');
                                incrementalDom.elementOpenStart('div');
                                    incrementalDom.attr('aria-labelledby', 'accordion03HeadingTwo__' + field7577Data);
                                    incrementalDom.attr('class', 'panel-collapse collapse ' + (_isOpenField__soy7433 == 'true' ? 'show' : ''));
                                    incrementalDom.attr('id', 'accordion03CollapseTwo' + field7577Data);
                                    ...
                                    incrementalDom.elementOpenEnd();
                                      ...
                                      incrementalDom.elementOpenEnd();
                                        if ((nestedFields != null)) {
                                          var nestedField7569List = nestedFields;
                                          var nestedField7569ListLen = nestedField7569List.length;
                                          for (var nestedField7569Index = 0; nestedField7569Index < nestedField7569ListLen; nestedField7569Index++) {
                                              var nestedField7569Data = nestedField7569List[nestedField7569Index];
                                              incrementalDom.elementOpenStart('div');
                                                  incrementalDom.attr('style', 'width:98%');
                                              incrementalDom.elementOpenEnd();
                                                if (nestedField7569Data['type'] == 'text') {
                                                  $templateAlias1({id: nestedField7569Data['name'] + '_' + field7577Data, type: nestedField7569Data['type'], path: field7577Data + '/' + nestedField7569Data['name'], localizable: nestedField7569Data['localizable'], labels: nestedField7569Data['label'], placeholder: nestedField7569Data['tip'], contextPath: contextPath, availableLanguageIds: availableLanguageIds, defaultLanguageId: defaultLanguageId, handleChangeValue: handleChangeValueDocument}, null, opt_ijData);
                                                } else if (nestedField7569Data['type'] == 'checkbox') {
                                                  $templateAlias2({id: nestedField7569Data['name'] + '_' + field7577Data, label: nestedField7569Data['label'], defaultLanguageId: defaultLanguageId, path: field7577Data + '/' + nestedField7569Data['name'], handleChangeValue: handleChangeValueDocument}, null, opt_ijData);
                                                } else if (nestedField7569Data['type'] == 'ddm-date') {
                                                  $templateAlias3({id: nestedField7569Data['name'] + '_' + field7577Data, label: nestedField7569Data['label'][defaultLanguageId], placeholder: nestedField7569Data['tip'][defaultLanguageId], defaultLanguageId: defaultLanguageId, path: field7577Data + '/' + nestedField7569Data['name'], handleChangeValue: handleChangeValueDocument}, null, opt_ijData);
                                                } else if (nestedField7569Data['type'] == 'ddm-text-html' || nestedField7569Data['type'] == 'textarea') {
                                                  $templateAlias4({id: nestedField7569Data['name'] + '_' + field7577Data, type: nestedField7569Data['type'], label: field7577Data['label'][defaultLanguageId], placeholder: nestedField7569Data['tip'][defaultLanguageId], availableLanguageIds: availableLanguageIds, defaultLanguageId: defaultLanguageId, path: field7577Data + '/' + nestedField7569Data['name'], handleChangeValue: handleChangeValueDocument, contextPath: contextPath}, null, opt_ijData);
                                                } else if (nestedField7569Data['type'] == 'radio') {
                                                  $templateAlias5({id: nestedField7569Data['name'] + '_' + field7577Data, label: nestedField7569Data['label'][defaultLanguageId], defaultLanguageId: defaultLanguageId, options: nestedField7569Data['options'], path: field7577Data + '/' + nestedField7569Data['name'], handleChangeValue: handleChangeValueDocument}, null, opt_ijData);
                                                } else if (nestedField7569Data['type'] == 'select') {
                                                  $templateAlias6({id: nestedField7569Data['name'] + '_' + field7577Data, label: nestedField7569Data['label'][defaultLanguageId], defaultLanguageId: defaultLanguageId, options: nestedField7569Data['options'], path: field7577Data + '/' + nestedField7569Data['name'], multiple: field7577Data['multiple'], handleChangeValue: handleChangeValueDocument}, null, opt_ijData);
                                                } else if (nestedField7569Data['type'] == 'ddm-integer') {
                                                  $templateAlias1({id: nestedField7569Data['name'] + '_' + field7577Data, type: 'number', path: field7577Data + '/' + nestedField7569Data['name'], localizable: nestedField7569Data['localizable'], labels: nestedField7569Data['label'], placeholder: nestedField7569Data['tip'], contextPath: contextPath, availableLanguageIds: availableLanguageIds, defaultLanguageId: defaultLanguageId, handleChangeValue: handleChangeValueDocument}, null, opt_ijData);
                                                } else {
                                                  soyIdom.print(nestedField7569Data['type']);
                                                  incrementalDom.text('--');
                                                  soyIdom.print(nestedField7569Data['name']);
                        ...
                        if (field7577Index == field7577ListLen - 1) {
                          incrementalDom.elementClose('tr');
                        }
                      }
                  }
          ...
          incrementalDom.elementOpenEnd();
                ...
                incrementalDom.elementOpenEnd();
                  ...
                  incrementalDom.elementOpenEnd();
                    ...
                    incrementalDom.elementOpenEnd();
                      ...
                      if (foldersDocuments) {
                        var field7609List = foldersDocuments;
                        var field7609ListLen = field7609List.length;
                        for (var field7609Index = 0; field7609Index < field7609ListLen; field7609Index++) {
                            var field7609Data = field7609List[field7609Index];
                            incrementalDom.elementOpenStart('option');
                                incrementalDom.attr('value', field7609Data.folderId);
                            incrementalDom.elementOpenEnd();
                              soyIdom.print(field7609Data.nameFolder);
                            incrementalDom.elementClose('option');
                          }
                      }
            ...
            incrementalDom.elementOpenEnd();
              ...
              incrementalDom.elementOpenEnd();
                incrementalDom.elementOpen('tbody');
                  if (itemsResult) {
                    var field7662List = itemsResult;
                    var field7662ListLen = field7662List.length;
                    for (var field7662Index = 0; field7662Index < field7662ListLen; field7662Index++) {
                        var field7662Data = field7662List[field7662Index];
                        if (field7662Index == 0) {
                            incrementalDom.elementOpen('tr');
                          }
                          if ((field7662Index + 2) % 2 == 0 && !(field7662Index == 0)) {
                            incrementalDom.elementClose('tr');
                          incrementalDom.elementOpen('tr');
                          }
                          incrementalDom.elementOpenStart('td');
                                ...
                                incrementalDom.elementOpenEnd();
                                  incrementalDom.elementOpen('label');
                                    if ((itemsResultSelected != null)) {
                                      if (itemsResultSelected[field7662Data.idFile]) {
                                        incrementalDom.elementOpenStart('input');
                                            incrementalDom.attr('checked', '');
                                            incrementalDom.attr('onclick', setSelectedResult);
                                            incrementalDom.attr('value', field7662Data.all);
                                            incrementalDom.attr('id', field7662Data.idFile);
                              ...
                              incrementalDom.elementOpenEnd();
                                ...
                                incrementalDom.elementOpenEnd();
                                  incrementalDom.elementOpenStart('img');
                                      ...
                                      incrementalDom.attr('style', 'max-height: 256px;max-width: 100%');
                                      incrementalDom.attr('alt', 'Not Image');
                                      incrementalDom.attr('src', 'http://' + _host___soy7425 + field7662Data.imageThumbnail);
                                  incrementalDom.elementOpenEnd();
                                  incrementalDom.elementClose('img');
                                incrementalDom.elementClose('span');
                              incrementalDom.elementClose('div');
                              ...
                              incrementalDom.elementOpenEnd();
                                ...
                                incrementalDom.elementOpenEnd();
                                  incrementalDom.elementOpenStart('a');
                                      incrementalDom.attr('href', '#1');
                                  incrementalDom.elementOpenEnd();
                                    soyIdom.print(field7662Data.filename);
                                  incrementalDom.elementClose('a');
                                incrementalDom.elementClose('h4');
                                incrementalDom.elementOpenStart('p');
                                    incrementalDom.attr('class', 'text-truncate-inline');
                                incrementalDom.elementOpenEnd();
                                  soyIdom.print(field7662Data.path);
                                incrementalDom.elementClose('p');
                              incrementalDom.elementClose('div');
                            incrementalDom.elementClose('div');
                          incrementalDom.elementClose('td');
                        if (field7662Index == field7662ListLen - 1) {
                          incrementalDom.elementClose('tr');
                        }
                      }
                  }
            ...
            incrementalDom.elementOpenEnd();
              ...
              incrementalDom.elementOpenEnd();
                ...
                incrementalDom.elementOpenEnd();
                  ...
                  incrementalDom.elementClose('option');
                  if (foldersDocuments) {
                    var field7694List = foldersDocuments;
                    var field7694ListLen = field7694List.length;
                    for (var field7694Index = 0; field7694Index < field7694ListLen; field7694Index++) {
                        var field7694Data = field7694List[field7694Index];
                        incrementalDom.elementOpenStart('option');
                            incrementalDom.attr('value', field7694Data.folderId);
                        incrementalDom.elementOpenEnd();
                          soyIdom.print(field7694Data.nameFolder);
                        incrementalDom.elementClose('option');
                      }
                  }
                incrementalDom.elementClose('select');
