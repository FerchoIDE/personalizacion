...
function $render(opt_data, opt_ijData, opt_ijData_deprecated) {
  ...
  var show__soy3840 = ((collapseInfo == null ? null : collapseInfo['accordion' + id + 'Heading']) != null) ? ((collapseInfo == null ? null : collapseInfo['accordion' + id + 'Heading']) ? '' : 'show') : '';
    ...
    incrementalDom.elementOpenEnd();
      ...
      incrementalDom.elementOpenEnd();
        ...
        incrementalDom.elementOpenStart('div');
            ...
            incrementalDom.attr('class', 'panel-collapse collapse ' + show__soy3840);
        ...
        incrementalDom.elementOpenEnd();
          ...
          incrementalDom.elementOpenEnd();
            ...
            incrementalDom.elementOpenEnd();
              ...
              incrementalDom.elementOpenEnd();
                var field3961List = data;
                var field3961ListLen = field3961List.length;
                for (var field3961Index = 0; field3961Index < field3961ListLen; field3961Index++) {
                    var field3961Data = field3961List[field3961Index];
                    if (field3961Data['type'] == 'ddm-separator') {
                      incrementalDom.text('anidado');
                      incrementalDom.elementOpen('br');
                      incrementalDom.elementClose('br');
                    } else if (field3961Data['type'] == 'text') {
                      $templateAlias1({id: field3961Data['name'], path: path + '/' + field3961Data['name'], type: field3961Data['type'], labels: field3961Data['label'], placeholder: field3961Data['tip'], localizable: field3961Data['localizable'], availableLanguageIds: availableLanguageIds, defaultLanguageId: defaultLanguage, handleChangeValue: handleChangeValue}, null, opt_ijData);
                    } else if (field3961Data['type'] == 'checkbox') {
                      $templateAlias2({id: field3961Data['name'], nameParent: name, label: field3961Data['label'][defaultLanguage], checkedOption: checkedOption, path: path + '/' + field3961Data['name'], handleChangeValue: handleChangeValue}, null, opt_ijData);
                    } else if (field3961Data['type'] == 'ddm-date') {
                      $templateAlias3({id: field3961Data['name'], label: field3961Data['label'][defaultLanguage], placeholder: field3961Data['tip'][defaultLanguage], defaultLanguageId: defaultLanguage, path: path + '/' + field3961Data['name'], handleChangeValue: handleChangeValue}, null, opt_ijData);
                    } else if (field3961Data['type'] == 'ddm-text-html') {
                      $templateAlias4({id: field3961Data['name'], label: field3961Data['label'][defaultLanguage], placeholder: field3961Data['tip'][defaultLanguage], availableLanguageIds: availableLanguageIds, defaultLanguageId: defaultLanguage, path: path + '/' + field3961Data['name'], handleChangeValue: handleChangeValue}, null, opt_ijData);
                    } else if (field3961Data['type'] == 'ddm-journal-article') {
                      $templateAlias5({id: field3961Data['name'], label: field3961Data['label'][defaultLanguage], contextPath: contextPath, brandSelected: brandSelected, hotelSelected: hotelSelected, path: path + '/' + field3961Data['name']}, null, opt_ijData);
                    } else if (field3961Data['type'] == 'ddm-documentlibrary') {
                      $templateAlias6({id: field3961Data['name'], label: field3961Data['label'][defaultLanguage], contextPath: contextPath, brandSelected: brandSelected, hotelSelected: hotelSelected, nestedFields: field3961Data['nestedFields'], availableLanguageIds: availableLanguageIds, defaultLanguageId: defaultLanguage, handleChangeValue: handleChangeValue, path: path + '/' + field3961Data['name']}, null, opt_ijData);
                    } else if (field3961Data['type'] == 'radio') {
                      $templateAlias7({id: field3961Data['name'], label: field3961Data['label'][defaultLanguage], defaultLanguageId: defaultLanguage, options: field3961Data['options'], path: path + '/' + field3961Data['name'], handleChangeValue: handleChangeValue}, null, opt_ijData);
                    } else if (field3961Data['type'] == 'select') {
                      $templateAlias8({id: field3961Data['name'], label: field3961Data['label'][defaultLanguage], defaultLanguageId: defaultLanguage, options: field3961Data['options'], path: path + '/' + field3961Data['name'], handleChangeValue: handleChangeValue}, null, opt_ijData);
                    } else {
                      soyIdom.print(field3961Data['type']);
