...
ViewNested.render = function(opt_data, opt_ignored) {
  ...
  var fieldList113 = data;
  var fieldListLen113 = fieldList113.length;
  for (var fieldIndex113 = 0; fieldIndex113 < fieldListLen113; fieldIndex113++) {
    var fieldData113 = fieldList113[fieldIndex113];
    output += (fieldData113['type'] == 'ddm-separator') ? 'anidado<br/>' : (fieldData113['type'] == 'text') ? TextLocalizableUI.render({id: fieldData113['name'], type: fieldData113['type'], labels: fieldData113['label'], placeholder: fieldData113['tip'], availableLanguageIds: availableLanguageIds, defaultLanguageId: defaultLanguage}) : (fieldData113['type'] == 'checkbox') ? CheckBoxUI.render({id: fieldData113['name'], label: fieldData113['label'][defaultLanguage]}) : (fieldData113['type'] == 'ddm-date') ? DateUI.render({id: fieldData113['name'], label: fieldData113['label'][defaultLanguage], placeholder: fieldData113['tip'][defaultLanguage], defaultLanguageId: defaultLanguage}) : (fieldData113['type'] == 'ddm-text-html') ? TextAreaUI.render({id: fieldData113['name'], label: fieldData113['label'][defaultLanguage], placeholder: fieldData113['tip'][defaultLanguage], availableLanguageIds: availableLanguageIds, defaultLanguageId: defaultLanguage}) : (fieldData113['type'] == 'ddm-journal-article') ? JournalUI.render({id: fieldData113['name'], label: fieldData113['label'][defaultLanguage], contextPath: contextPath}) : soy.$$escapeHtml(fieldData113['type']) + ' -- Ninguno<br/>';
  }
