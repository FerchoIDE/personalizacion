...
function $render(opt_data, opt_ijData, opt_ijData_deprecated) {
  ...
  var structureIdRate__soy6249 = '35796';
  var show__soy6251 = ((collapseInfo == null ? null : collapseInfo['accordion' + id + 'Heading']) != null) ? ((collapseInfo == null ? null : collapseInfo['accordion' + id + 'Heading']) ? '' : 'show') : '';
  var _countSections__soy6253 = (countSection != null) ? countSection : [0];
    ...
    incrementalDom.elementOpenEnd();
      ...
      incrementalDom.elementOpenEnd();
        ...
        incrementalDom.elementOpenStart('div');
            ...
            incrementalDom.attr('class', 'panel-collapse collapse ' + show__soy6251);
        ...
        incrementalDom.elementOpenEnd();
          ...
          incrementalDom.elementOpenEnd();
            if (repeatable) {
              ...
              incrementalDom.elementOpenEnd();
                var _countSection6415List = _countSections__soy6253;
                var _countSection6415ListLen = _countSection6415List.length;
                for (var _countSection6415Index = 0; _countSection6415Index < _countSection6415ListLen; _countSection6415Index++) {
                    var _countSection6415Data = _countSection6415List[_countSection6415Index];
                    incrementalDom.elementOpenStart('div');
                        incrementalDom.attr('class', 'input-group');
                    incrementalDom.elementOpenEnd();
                      var field6402List = data;
                      var field6402ListLen = field6402List.length;
                      for (var field6402Index = 0; field6402Index < field6402ListLen; field6402Index++) {
                          var field6402Data = field6402List[field6402Index];
                          if (field6402Data['type'] == 'ddm-separator') {
                            incrementalDom.text('anidado');
                            incrementalDom.elementOpen('br');
                            incrementalDom.elementClose('br');
                          } else if (field6402Data['type'] == 'text') {
                            $templateAlias1({id: field6402Data['name'] + '___' + _countSection6415Index, path: path + '___' + _countSection6415Index + '/' + field6402Data['name'], type: field6402Data['type'], labels: field6402Data['label'], placeholder: field6402Data['tip'], localizable: field6402Data['localizable'], values: field6402Data['values'], repeatable: field6402Data['repeatable'], contextPath: contextPath, _index: _countSection6415Index, availableLanguageIds: availableLanguageIds, defaultLanguageId: defaultLanguage, handleChangeValue: handleChangeValue}, null, opt_ijData);
                          } else if (field6402Data['type'] == 'checkbox') {
                            $templateAlias2({id: field6402Data['name'] + '___' + _countSection6415Index, nameParent: name, label: field6402Data['label'], checkedOption: checkedOption, path: path + '___' + _countSection6415Index + '/' + field6402Data['name'], defaultLanguageId: defaultLanguage, handleChangeValue: handleChangeValue}, null, opt_ijData);
                          } else if (field6402Data['type'] == 'ddm-date') {
                            $templateAlias3({id: field6402Data['name'] + '___' + _countSection6415Index, values: field6402Data['values'], label: field6402Data['label'][defaultLanguage], placeholder: field6402Data['tip'][defaultLanguage], defaultLanguageId: defaultLanguage, path: path + '___' + _countSection6415Index + '/' + field6402Data['name'], handleChangeValue: handleChangeValue}, null, opt_ijData);
                          } else if (field6402Data['type'] == 'ddm-text-html' || field6402Data['type'] == 'textarea') {
                            $templateAlias4({id: field6402Data['name'] + '___' + _countSection6415Index, type: field6402Data['type'], label: field6402Data['label'][defaultLanguage], placeholder: field6402Data['tip'][defaultLanguage], availableLanguageIds: availableLanguageIds, defaultLanguageId: defaultLanguage, path: path + '___' + _countSection6415Index + '/' + field6402Data['name'], handleChangeValue: handleChangeValue, contextPath: contextPath}, null, opt_ijData);
                          } else if (field6402Data['type'] == 'ddm-journal-article') {
                            $templateAlias5({id: field6402Data['name'] + '___' + _countSection6415Index, label: field6402Data['label'][defaultLanguage], contextPath: contextPath, brandSelected: brandSelected, hotelSelected: hotelSelected, brandIdSelected: brandIdSelected, handleChangeValue: handleChangeValue, handleRemoveValue: handleRemoveValue, hotelIdSelected: hotelIdSelected, path: path + '___' + _countSection6415Index + '/' + field6402Data['name']}, null, opt_ijData);
                          } else if (field6402Data['type'] == 'ddm-documentlibrary') {
                            $templateAlias6({id: field6402Data['name'] + '___' + _countSection6415Index, label: field6402Data['label'][defaultLanguage], contextPath: contextPath, brandSelected: brandSelected, hotelSelected: hotelSelected, nestedFields: field6402Data['nestedFields'], availableLanguageIds: availableLanguageIds, defaultLanguageId: defaultLanguage, handleChangeValue: handleChangeValue, handleRemoveValue: handleRemoveValue, path: path + '___' + _countSection6415Index + '/' + field6402Data['name']}, null, opt_ijData);
                          } else if (field6402Data['type'] == 'radio') {
                            $templateAlias7({id: field6402Data['name'] + '___' + _countSection6415Index, values: field6402Data['values'], label: field6402Data['label'][defaultLanguage], defaultLanguageId: defaultLanguage, options: field6402Data['options'], path: path + '___' + _countSection6415Index + '/' + field6402Data['name'], handleChangeValue: handleChangeValue}, null, opt_ijData);
                          } else if (field6402Data['type'] == 'select') {
                            $templateAlias8({id: field6402Data['name'] + '___' + _countSection6415Index, values: field6402Data['values'], label: field6402Data['label'][defaultLanguage], defaultLanguageId: defaultLanguage, options: field6402Data['options'], path: path + '___' + _countSection6415Index + '/' + field6402Data['name'], multiple: field6402Data['multiple'], handleChangeValue: handleChangeValue}, null, opt_ijData);
                          } else {
                            soyIdom.print(field6402Data['type']);
                      ...
                      if ((checkedConcat != null)) {
                        if (structureId == structureIdRate__soy6249 && (checkedConcat[name] != null) && (name == 'Restrictions' || name == 'Benefits1' || name == 'occupationRate')) {
                          incrementalDom.elementClose('div');
                        incrementalDom.elementOpenStart('div');
                            incrementalDom.attr('class', 'input-group');
                        incrementalDom.elementOpenEnd();
              ...
              incrementalDom.elementOpenEnd();
                incrementalDom.elementOpenStart('div');
                    incrementalDom.attr('class', 'input-group');
                incrementalDom.elementOpenEnd();
                  var field6535List = data;
                  var field6535ListLen = field6535List.length;
                  for (var field6535Index = 0; field6535Index < field6535ListLen; field6535Index++) {
                      var field6535Data = field6535List[field6535Index];
                      if (field6535Data['type'] == 'ddm-separator') {
                        incrementalDom.text('anidado');
                        incrementalDom.elementOpen('br');
                        incrementalDom.elementClose('br');
                      } else if (field6535Data['type'] == 'text') {
                        $templateAlias1({id: field6535Data['name'], path: path + '/' + field6535Data['name'], type: field6535Data['type'], labels: field6535Data['label'], placeholder: field6535Data['tip'], localizable: field6535Data['localizable'], values: field6535Data['values'], repeatable: field6535Data['repeatable'], contextPath: contextPath, availableLanguageIds: availableLanguageIds, defaultLanguageId: defaultLanguage, handleChangeValue: handleChangeValue}, null, opt_ijData);
                      } else if (field6535Data['type'] == 'checkbox') {
                        $templateAlias2({id: field6535Data['name'], nameParent: name, label: field6535Data['label'], checkedOption: checkedOption, path: path + '/' + field6535Data['name'], values: field6535Data['values'], defaultLanguageId: defaultLanguage, handleChangeValue: handleChangeValue}, null, opt_ijData);
                      } else if (field6535Data['type'] == 'ddm-date') {
                        $templateAlias3({id: field6535Data['name'], values: field6535Data['values'], label: field6535Data['label'][defaultLanguage], placeholder: field6535Data['tip'][defaultLanguage], defaultLanguageId: defaultLanguage, path: path + '/' + field6535Data['name'], handleChangeValue: handleChangeValue}, null, opt_ijData);
                      } else if (field6535Data['type'] == 'ddm-text-html' || field6535Data['type'] == 'textarea') {
                        $templateAlias4({id: field6535Data['name'], type: field6535Data['type'], label: field6535Data['label'][defaultLanguage], placeholder: field6535Data['tip'][defaultLanguage], availableLanguageIds: availableLanguageIds, defaultLanguageId: defaultLanguage, path: path + '/' + field6535Data['name'], values: field6535Data['values'], handleChangeValue: handleChangeValue, contextPath: contextPath}, null, opt_ijData);
                      } else if (field6535Data['type'] == 'ddm-journal-article') {
                        $templateAlias5({id: field6535Data['name'], label: field6535Data['label'][defaultLanguage], values: field6535Data['values'], contextPath: contextPath, brandSelected: brandSelected, hotelSelected: hotelSelected, brandIdSelected: brandIdSelected, handleChangeValue: handleChangeValue, handleRemoveValue: handleRemoveValue, hotelIdSelected: hotelIdSelected, path: path + '/' + field6535Data['name']}, null, opt_ijData);
                      } else if (field6535Data['type'] == 'ddm-documentlibrary') {
                        $templateAlias6({id: field6535Data['name'], label: field6535Data['label'][defaultLanguage], contextPath: contextPath, brandSelected: brandSelected, hotelSelected: hotelSelected, nestedFields: field6535Data['nestedFields'], availableLanguageIds: availableLanguageIds, defaultLanguageId: defaultLanguage, handleChangeValue: handleChangeValue, handleRemoveValue: handleRemoveValue, path: path + '/' + field6535Data['name']}, null, opt_ijData);
                      } else if (field6535Data['type'] == 'radio') {
                        $templateAlias7({id: field6535Data['name'], values: field6535Data['values'], label: field6535Data['label'][defaultLanguage], defaultLanguageId: defaultLanguage, options: field6535Data['options'], path: path + '/' + field6535Data['name'], handleChangeValue: handleChangeValue}, null, opt_ijData);
                      } else if (field6535Data['type'] == 'select') {
                        $templateAlias8({id: field6535Data['name'], values: field6535Data['values'], label: field6535Data['label'][defaultLanguage], defaultLanguageId: defaultLanguage, options: field6535Data['options'], path: path + '/' + field6535Data['name'], multiple: field6535Data['multiple'], handleChangeValue: handleChangeValue}, null, opt_ijData);
                      } else {
                        soyIdom.print(field6535Data['type']);
                        incrementalDom.text(' -- Ninguno');
                        incrementalDom.elementOpen('br');
                        incrementalDom.elementClose('br');
                      }
