...
function $render(opt_data, opt_ijData, opt_ijData_deprecated) {
  ...
  var finalValue__soy1709 = (value != null) ? value : '';
  ...
  incrementalDom.elementOpenEnd();
    ...
    incrementalDom.elementOpenEnd();
      ...
      incrementalDom.elementOpenEnd();
        ...
        var option1728List = options;
        var option1728ListLen = option1728List.length;
        for (var option1728Index = 0; option1728Index < option1728ListLen; option1728Index++) {
            var option1728Data = option1728List[option1728Index];
            incrementalDom.elementOpenStart('option');
                incrementalDom.attr('value', option1728Data.value);
            incrementalDom.elementOpenEnd();
              soyIdom.print(option1728Data.label[defaultLanguageId]);
            incrementalDom.elementClose('option');
          }
