...
function $render(opt_data, opt_ijData, opt_ijData_deprecated) {
  ...
  var finalValue__soy1721 = (value != null) ? value : '';
  ...
  incrementalDom.elementOpenEnd();
    ...
    var language1760List = availableLanguageIds;
    var language1760ListLen = language1760List.length;
    for (var language1760Index = 0; language1760Index < language1760ListLen; language1760Index++) {
        var language1760Data = language1760List[language1760Index];
        if (language1760Data == defaultLanguageId) {
          incrementalDom.elementOpenStart('textarea');
              ...
              incrementalDom.attr('data-language', language1760Data);
              incrementalDom.attr('id', 'inputarea_' + id + '_' + language1760Data);
              incrementalDom.attr('placeholder', placeholder);
              incrementalDom.attr('value', finalValue__soy1721);
          incrementalDom.elementOpenEnd();
