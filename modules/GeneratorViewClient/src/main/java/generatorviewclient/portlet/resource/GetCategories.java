...
public class GetCategories implements MVCResourceCommand {
    ...
    public boolean serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
        ...
        try {
            ...
            List<AssetVocabulary> listVocabulary = this.assetVocabularyLocalService.getGroupVocabularies(portletGroupId);//getAssetVocabularies(0, this.assetVocabularyLocalService.getAssetVocabulariesCount());
