...
public class VocabularyApi extends QueriesLiferayApi implements IVocabularyApi{
    ...
    /**
     * M�todo getCategoriesByGroupAndVacabularyFirstLevel
     * @param groupId Id del s�tio
     * @param vocabularyId Id del vocabulario a iterar
     * @return <ul>
    ...
    /**
     * M�todo getSubCategories
     * @param parentCategoryId id de padre de categoria
     * @return <ul>
     *  <li>JSONArray, Todos las subcategorias  del sitio con sus elementos anidados recursivamente, sin discriminar ning�n valor</li>
     *  </ul>
     */
